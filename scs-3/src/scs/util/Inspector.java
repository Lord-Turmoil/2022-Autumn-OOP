...
public class Inspector {
	/**
	 * Check platform.user id and return corresponding type.
	 * @param id - platform.user.User id.
	 * @return Type of platform.user. Unknown if illegal.
	 */
	...
	/**
	 * Check platform.user's first name or last name.
	 * @param name platform.user.User name.
	...
	/**
	 * Check Email.
	 * @param email platform.user.User's email.
	...
	/**
	 * Check platform.user's password.
	 * @param password platform.user.User's password.
	...
	/**
	 * Check course ID.
	 * @param id platform.att.Course ID.
	...
	/**
	 * Check course name.
	 * @param name platform.att.Course name.
	...
	/**
	 * Check ware ID.
	 * @param id platform.att.Ware ID.
	 * @param prefix platform.att.Course ID.
	 * @return Whether is legal or not.
	 */
	 ...
	 * @return Whether is legal or not.
	 */
	public static boolean checkWareId(String id) {
		// 0 1    5 7
		// W cccc rr
		if (id == null) {
			return false;
		...
		// Check trivia.
		if (Integer.parseInt(id.substring(5)) == 0) {
			return false;
		}
	...
	/**
	 * Check ware name.
	 * @param name platform.att.Ware name.
	 * @return Whether is legal course name or not.
	 */
	 ...
	 * @return Whether is legal or not.
	 */
	public static boolean checkTaskId(String id) {
		// 0 1    5 7
		// T cccc rr
		if (id == null) {
			return false;
