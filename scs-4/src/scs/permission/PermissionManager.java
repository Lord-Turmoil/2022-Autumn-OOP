...
public class PermissionManager {
	...
	static {
		...
		control.addPermission(Permission.ClearVM);
		...
		control.addPermission(Permission.RequestVM);
		control.addPermission(Permission.StartVM);
		control.addPermission(Permission.LogVM);
		control.addPermission(Permission.UploadVM);
		control.addPermission(Permission.DownLoadVM);
	}
